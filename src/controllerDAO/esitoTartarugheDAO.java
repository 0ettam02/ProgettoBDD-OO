...
public class esitoTartarugheDAO {
	...
	// QUERY
			...
			public void queryDataLiberazione(String id_tartaruga, String data_liberazione) {
				try {
					cl.st.executeUpdate("INSERT INTO vita_tartarughe VALUES ('" + id_tartaruga + "','" + data_liberazione + "',null,'0')");
			...
			// QUERY
						...
						public void queryDataMorte(String id_tartaruga, String data_morte) {
							try {
								cl.st.executeUpdate("INSERT INTO vita_tartarughe VALUES ('" + id_tartaruga + "',null,'" + data_morte + "','0')");
							} catch (SQLException e) {
								// TODO Auto-generated catch block
								e.printStackTrace();
							}
