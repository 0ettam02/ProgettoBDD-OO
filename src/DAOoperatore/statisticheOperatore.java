...
public class statisticheOperatore extends JFrame {
	...
	public statisticheOperatore(accessoOperatore accesso) {
		...
		lblInvio.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				cntr.querySelezioneStatsOperatore(SD, comboBox, tableViewStats);
