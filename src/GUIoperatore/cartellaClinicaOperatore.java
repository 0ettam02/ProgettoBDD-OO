...
import query.cartellaClinicaDAO;
...
public class cartellaClinicaOperatore extends JFrame {
	...
	public cartellaClinicaOperatore(accessoOperatore accesso) {
		...
		lblInvio.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				CCD.queryInsertCartellaClinicaRicercatore(textFieldCartellaClinica.getText(),
						textFieldTartaruga.getText(), textFieldNomeTartaruga.getText(),
						textFieldLuogoRitrovamento.getText(), textFieldDataIngresso.getText());
